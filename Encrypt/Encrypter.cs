...
namespace ExtensionCore
{
    public static class Encrypter
    {
        ...
        public static string Encrypt(this string plainText, string passPhrase, CipherMode cipherMode)
        {
        ...
        /// <returns></returns>
        public static string Encrypt(this string plainText, string passPhrase, CipherMode cipherMode, PaddingMode paddingMode)
        {
        ...
        #region - Decrypt -
        public static string Decrypt(this string plainText, string passPhrase)
        {
            return Decrypt(plainText, passPhrase, CipherMode.CBC);
        }
        public static string Decrypt(this string plainText, string passPhrase, CipherMode cipherMode)
        {
        ...
        /// <param name="paddingMode">Dolgulama türü</param>
        /// <returns></returns>
        public static string Decrypt(this string cipherText, string passPhrase, CipherMode cipherMode, PaddingMode paddingMode)
        {
